...
class __TwigTemplate_866b8d81fa134040b773ebfbf8053fe511d3044264bacb9ba872018e8716c363 extends \Twig\Template
{
    private $source;
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 12, $this->source); })()), "id", []), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  110 => 21,  105 => 19,  100 => 17,  92 => 12,  84 => 6,  75 => 5,  57 => 3,  27 => 1,);
    }
...
{% endblock %}
", "reservation/show.html.twig", "C:\\xampp\\htdocs\\zinnig\\templates\\reservation\\show.html.twig");
    }
}
