...
class __TwigTemplate_784fda08795e49937273671e653fdcec4e7fca215bde4f0ad9aec73409314860 extends \Twig\Template
{
    private $source;
    ...
    <table class=\"table container table-striped table-bordered table-hover animated fadeIn\" style=\"max-width:90%\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["locations"]) || array_key_exists("locations", $context) ? $context["locations"] : (function () { throw new RuntimeError('Variable "locations" does not exist.', 19, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["location"]) {
            ...
            echo "            <tr>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["location"], "id", []), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["location"], "breedtegraad", []), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["location"], "lengtegraad", []), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["location"], "image", []), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 26
