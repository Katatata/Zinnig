...
return $this->privates['debug.argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    'App\\Controller\\ActivityController::delete' => ['privates', '.service_locator.AnVRYeU', 'get_ServiceLocator_AnVRYeUService.php', true],
    'App\\Controller\\ActivityController::edit' => ['privates', '.service_locator.AnVRYeU', 'get_ServiceLocator_AnVRYeUService.php', true],
    'App\\Controller\\ActivityController::index' => ['privates', '.service_locator.6kVGlNB', 'get_ServiceLocator_6kVGlNBService.php', true],
    'App\\Controller\\ActivityController::show' => ['privates', '.service_locator.AnVRYeU', 'get_ServiceLocator_AnVRYeUService.php', true],
