...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ActivityController' => 'getActivityControllerService.php',
    ...
    protected function getQrCodeFactoryService()
    {
        ...
        return $this->privates['Endroid\QrCode\Factory\QrCodeFactory'] = new \Endroid\QrCode\Factory\QrCodeFactory(['writer' => 'svg', 'size' => 300, 'margin' => 10, 'foreground_color' => ['r' => 0, 'g' => 0, 'b' => 0, 'a' => 0], 'background_color' => ['r' => 255, 'g' => 255, 'b' => 255, 'a' => 0], 'error_correction_level' => 'low', 'encoding' => 'UTF-8', 'label' => 'Scan the code', 'label_font_size' => 20, 'label_alignment' => 'left', 'label_margin' => ['b' => 20], 'validate_result' => false, 'writer_options' => ['exclude_xml_declaration' => true]], $a);
    }
