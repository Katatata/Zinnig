...
class __TwigTemplate_4c7d23b9a2714ce4b15997fd19e9108d73757788e327852f7a47a603543661d5 extends \Twig\Template
{
    private $source;
...
<div class=\"fos_user_user_show\">
    <p>";
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 4, $this->source); })()), "username", []), "html", null, true);
        echo "</p>
    <p>";
        // line 5
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 5, $this->source); })()), "email", []), "html", null, true);
        echo "</p>
</div>
";
...
", "FOSUserBundle:Profile:show_content.html.twig", "C:\\xampp\\htdocs\\zinnig\\vendor\\friendsofsymfony\\user-bundle/Resources/views/Profile/show_content.html.twig");
    }
}
