...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getQrCodeFactoryService()
    {
        ...
        return $this->privates['Endroid\QrCode\Factory\QrCodeFactory'] = new \Endroid\QrCode\Factory\QrCodeFactory(['writer' => 'png', 'size' => 300, 'margin' => 10, 'error_correction_level' => 'low', 'validate_result' => false, 'writer_options' => [], 'encoding' => 'UTF-8'], $a);
    }
